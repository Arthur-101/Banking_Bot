...
def toplevel_login_new():
    ...
    frame_regis = CTkFrame(master=toplevel1,border_width=4,border_color='#3f60fc',fg_color='#3f60fc',
        width=WID-293, height=HEI, corner_radius=0)
    frame_regis.grid(row=0,column=2, rowspan=2, pady=(0,20),padx=(10,0),)
    ...
    frame_regis_label.grid(row=2,column=1,padx=(10,35),)
...
def toplevel_register_new():
    ...
    frame_log = CTkFrame(master=toplevel1,border_width=4,border_color='#3f60fc',fg_color='#3f60fc',
        width=WID-293, height=HEI, corner_radius=0)
    frame_log.grid(row=0,column=1, rowspan=2, pady=(0,20),padx=(10,0),)
    ...
    frame_log_label.grid(row=2,column=1,padx=(10,33),)
    ...
    label_register.grid(row=0,column=2,padx=10,pady=(10,10),sticky='s')
