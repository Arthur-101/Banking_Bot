...
def toplevel_login_new():
    ...
    frame_login.grid(row=1,column=1,pady=(0,20),padx=(20,0), sticky='n')
    ...
    frame_regis.grid(row=0,column=2, rowspan=2, pady=(0,20),padx=(20,0),)
    
    frame_regis_label = CTkLabel(master=frame_regis, text="\n"*8,font=('Roboto',20,'bold'))
    frame_regis_label.grid(row=1,column=1,)
    
    frame_regis_label = CTkLabel(master=frame_regis, text="Don't have an account?",font=('Roboto',30,'bold'))
    frame_regis_label.grid(row=2,column=1,padx=(15,40),)

    button2 = CTkButton(master=frame_regis_label,text='Register',font=('Roboto',24),border_width=3,corner_radius=15,
    border_color='#ffffff',fg_color='#ffffff',text_color='#3e9eff',hover_color='#d7d7d7',command=toplevel_register_new)
    button2.grid(row=3,column=0,pady=(15,10))

    frame_regis_label = CTkLabel(master=frame_regis, text="\n"*10,font=('Roboto',20,'bold'))
    frame_regis_label.grid(row=4,column=1,)
