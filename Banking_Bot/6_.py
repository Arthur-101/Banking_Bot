...
def enter():
    ...
    if command1 in ['help','/help']:
        ...
        try:
            ...
            root1.iconbitmap('Files/Items/bot_warning.jpg')
            playsound('Files/Items/error-2.mp3',block=False)
            textbox3.insert("0.0","ERROR!!")
...
def main_window_widgets():
    ...
    # Remove all the widgets from the main window
    ...
    appearance_mode_optionemenu.grid(row=6, column=0, padx=(5,15),)
    ...
    button2 = CTkButton(master=root1,text='Start',border_width=3,corner_radius=10,hover_color='#35dd17',
        border_color='#3f60fc',font=('Roboto',18,),command=second_window)
...
def second_window():
    ...
    # Creating a frame    
    frame2 = CTkFrame(master=root1,border_width=2)
    frame2.grid(row=1,column=0,pady=(0,0),padx=0,rowspan=4)
    ...
    frame2_button1 = CTkButton(master=frame2,text='',width=169,height=80,border_color='#3f60fc',fg_color='transparent',
        hover_color='#35dd17',border_width=3,image=home_image,compound=LEFT,command=main_window_widgets)
    ...
    frame2_button2 = CTkButton(master=frame2,text='',width=169,height=80,border_color='#3f60fc',fg_color='transparent',
        hover_color='#f8182f',border_width=3,image=exit_image,command=root1.destroy)
    ...
    appearance_mode_optionemenu =CTkOptionMenu(master=frame2, values=["Dark","Light", "System"],fg_color='#0379fc',
        button_color='#0756cb',command=change_appearance_mode_event)
    appearance_mode_optionemenu.grid(row=5, column=0, padx=20,pady=(0,23))

    # radio buttons : For decoration
    radio1 = CTkRadioButton(master=root1,text="-"*19,fg_color='#f30701')
    radio1.grid(row=1,column=1)
    
    radio2 = CTkRadioButton(master=root1,text="-"*19,fg_color='#2424ff')
    radio2.grid(row=2,column=1)
    
    radio3 = CTkRadioButton(master=root1,text="-"*19,fg_color='#ede807')
    radio3.grid(row=3,column=1)
    
    radio4 = CTkRadioButton(master=root1,text="-"*19,fg_color='#26c115')
    radio4.grid(row=4,column=1)

    # Creating a Tabview
    tabview1 = CTkTabview(master=root1,width=250,height=200,border_width=4,border_color='#3f60fc')
    ...
    tabview1_label2 = CTkLabel(master=tabview1.tab("Customer"),text="➡  Don't have an account?",
        font=('Roboto',18,))
    tabview1_label2.grid(row=3,column=0,padx=(20,5),pady=(20,10),sticky='s')
    ...
    tabview1_label1 = CTkLabel(master=tabview1.tab("Employee"),text="➡  Employee Login               ",
        font=('Roboto',18,))
    tabview1_label1.grid(row=0,column=0,padx=(20,13),pady=(20,10),sticky='s')
...
def after_login_window():
    ...
    # label_1 : HEADING
    label_1 = CTkLabel(master=root1,text='Your Profile',font=('Roboto',25,'underline'))
    label_1.grid(row=1,column=1,pady=10,padx=60,ipadx=20,columnspan=2,)

    # Creating 1st frame
    frame3 = CTkFrame(master=root1,border_width=2)
    ...
    frame3_button1 = CTkButton(master=frame3,text='',width=169,height=80,border_color='#3f60fc',fg_color='transparent',
        hover_color='#35dd17',border_width=3,image=home_image,font=('Roboto',15,),command=main_window_widgets)
    ...
    frame3_button3 = CTkButton(master=frame3,text='',width=169,height=80,border_color='#3f60fc',fg_color='transparent',
        hover_color='#f8182f',border_width=3,image=exit_image,font=('Roboto',15,),command=root1.destroy)
    ...
    label_appearance.grid(row=4,column=0,padx=10,pady=(20,5),sticky='ws')
    ...
    label_2 = CTkLabel(master=root1,text='Account no. : \n\nUsername    : \n\nE-mail      : ',font=('Courier New',22,))
    label_2.grid(row=2,column=1,pady=(10,0),padx=(20,0),sticky='en')
    label_3 = CTkLabel(master=root1,text='Balance     : ',font=('Courier New',22,))
    label_3.grid(row=3,column=1,pady=(0,10),padx=(20,0),sticky='en')

    label_user_info = CTkLabel(master=root1,text=user_info,font=('Courier New',22,))
    label_user_info.grid(row=2,column=2,pady=(0,10),padx=(20,0),sticky='w')
    label_money_info = CTkLabel(master=root1,text=f'₹ {user_money}',font=('Courier New',22,))
    label_money_info.grid(row=3,column=2,pady=(0,10),padx=(20,0),sticky='wn')

    # Creating a Tabview
    tabview_2 = CTkTabview(master=root1,width=250,height=200,border_width=2,)
    ...
    tabview2_label1 = CTkLabel(master=tabview_2.tab("Withdraw"),
        text="➡        Enter the Amount to Withdraw :"+" "*57,font=('Roboto',18,))
    ...
    tabview2_label2 = CTkLabel(master=tabview_2.tab("Deposit"),
        text="➡        Enter the Amount to Deposit : "+" "*60,font=('Roboto',18,))
    ...
    tabview2_label3_1 = CTkLabel(master=tabview_2.tab("Loan"),font=('Roboto',18,),
        text='Our Bank provides Loan at 9% per Annum'+" "*42,)
    tabview2_label3_1.grid(row=0,column=0,padx=(20,0),pady=(15,0),columnspan=2,sticky='s')
    tabview2_label3_2 = CTkLabel(master=tabview_2.tab("Loan"),font=('Roboto',18,),
        text='    ➡         Enter the Amount you want to Borrow : '+" "*42,)
    tabview2_label3_2.grid(row=1,column=0,padx=(20,0),pady=(0,10),columnspan=2,sticky='s')
...
def after_login_window_emp():
    ...
    # Creating 1st frame
    frame4 = CTkFrame(master=root1,border_width=2)
    ...
    # Creating a Tabview
    tabview_3 = CTkTabview(master=root1,width=250,height=200,border_width=2,)
    tabview_3.grid(row=1,column=1,pady=(10,0), ipady=12, ipadx=80,columnspan=2,rowspan=2,sticky="nsew")
    tabview_3.add("All")
    ...
    tabview3_label2.grid(row=2,column=1,pady=(0,11),padx=(20,0),sticky='wn')
    tabview3_label3 = CTkLabel(master=tabview_3.tab('Search'),text='\n',)
    tabview3_label3.grid(row=3,column=1,pady=(0,11),padx=(20,0),)
    ...
    frame4_2 = CTkFrame(master=root1,border_width=2)
    frame4_2.grid(row=3,column=1,pady=(0,0),padx=0,columnspan=2,rowspan=2)
    ...
    frame4_2_label1.grid(row=4,column=0,padx=20,pady=(0,20),columnspan=2,sticky='s')
...
def toplevel_login():
    ...
    toplevel1.geometry(f"{WID}x{HEI}")
    toplevel1.minsize(WID,HEI)
    toplevel1.maxsize(WID,HEI)

    toplevel_login_new()

def toplevel_login_new():
    global entry_lusername
    global entry_lpassword
    global button_log
    global button_log_original_x, button_log_original_y
    
     # Remove all the widgets from the main window
    try:
        for widget in toplevel1.winfo_children():
            widget.destroy()
    except:
        pass
    ...
    label_login = CTkLabel(master=toplevel1, text='Login', font=('Roboto', 26))
    label_login.place(x=60, y=30)

    # Login Frame
    frame_login = CTkFrame(master=toplevel1, border_width=4, border_color='#3f60fc')
    frame_login.place(x=20, y=80, width=300, height=470)

    label_username = CTkLabel(master=frame_login, text='Enter Username', font=('Roboto', 20))
    label_username.place(x=60, y=10)

    entry_lusername = CTkEntry(master=frame_login, placeholder_text="           Username",
        border_width=3, corner_radius=10, border_color='#3f60fc', font=('Roboto', 15))
    entry_lusername.place(x=35, y=60, width=200)

    label_password = CTkLabel(master=frame_login, text='Enter Password', font=('Roboto', 20))
    label_password.place(x=60, y=110)

    entry_lpassword = CTkEntry(master=frame_login, placeholder_text="           Password", show='*',
        border_width=3, corner_radius=10, border_color='#3f60fc', font=('Roboto', 15))
    entry_lpassword.place(x=35, y=160, width=200)

    switch_lpassword = CTkSwitch(master=frame_login, text='Show', font=('Roboto', 12), switch_height=15,
        switch_width=30, command=lambda: pass_switch(switch_lpassword))
    switch_lpassword.place(x=90, y=220)

    button_log = CTkButton(master=frame_login, text='Login', border_width=3, corner_radius=15, 
        border_color='#3f60fc', command=login_system)
    button_log.place(x=90, y=280, width=100)
    button_log_original_x = button_log.winfo_x()
    button_log_original_y = button_log.winfo_y()
    button_log.bind('<Enter>', move_away)
    button_log.bind('<Leave>', move_back)

    frame_regis = CTkFrame(master=toplevel1, border_width=4, border_color='#3f60fc', fg_color='#3f60fc',
        width=WID-300, height=HEI, corner_radius=0)
    frame_regis.place(x=WID-280, y=20)

    frame_regis_label = CTkLabel(master=frame_regis, text="Don't have an account?", font=('Roboto', 30, 'bold'))
    frame_regis_label.place(x=20, y=10)

    button2 = CTkButton(master=frame_regis, text='Register', font=('Roboto', 24), border_width=3, corner_radius=15,
        border_color='#ffffff', fg_color='#ffffff', text_color='#3e9eff', hover_color='#d7d7d7',
        command=toplevel_register_new)
    button2.place(x=20, y=90)

def move_away(event):
    # Move the button away from the mouse
    button_log.place(x=button_log_original_x, y=button_log_original_y+5)

def move_back(event):
    # Move the button back to its original position
    button_log.place(x=button_log_original_x, y=button_log_original_y)
...
def toplevel_register():
    ...
    # toplevel2.geometry(f"{WID}x{HEI}")
    # toplevel2.minsize(WID,HEI)
    # toplevel2.maxsize(WID,HEI)
    toplevel1 = CTkToplevel()
    toplevel1.title('Login')
    toplevel1.geometry(f"{WID}x{HEI}")
    toplevel1.minsize(WID,HEI)
    ...
    toplevel_register_new()

def toplevel_register_new():
    global entry_rusername
    global entry_rpassword1
    global entry_rpassword2
    global entry_rgmail
    ...
    toplevel1.title('Register')

    frame_log = CTkFrame(master=toplevel1,border_width=4,border_color='#3f60fc',fg_color='#3f60fc',
        width=WID-295, height=HEI, corner_radius=0)
    frame_log.grid(row=0,column=1, rowspan=2, pady=(0,20),padx=(0,0),)
    
    frame_log_label = CTkLabel(master=frame_log, text="\n"*8,font=('Roboto',20,'bold'))
    frame_log_label.grid(row=1,column=1,)
    
    frame_log_label = CTkLabel(master=frame_log, text="Already have an account?",font=('Roboto',30,'bold'))
    frame_log_label.grid(row=2,column=1,padx=(10,10),)

    button2 = CTkButton(master=frame_log_label,text='Login',font=('Roboto',24),border_width=3,corner_radius=15,
    border_color='#ffffff',fg_color='#ffffff',text_color='#3e9eff',hover_color='#d7d7d7',command=toplevel_login_new)
    button2.grid(row=3,column=0,pady=(15,10))

    frame_log_label = CTkLabel(master=frame_log, text="\n"*10,font=('Roboto',20,'bold'))
    frame_log_label.grid(row=4,column=1,)

    # Login Frame
    label_register = CTkLabel(master=toplevel1,text='Register',font=('Roboto',22,))
    label_register.grid(row=0,column=2,padx=10,pady=(0,0),sticky='s')

    frame_register = CTkFrame(master=toplevel1,border_width=4,border_color='#3f60fc')
    frame_register.grid(row=1,column=2,pady=(0,20),padx=20)

    label_username = CTkLabel(master=frame_register,text='Create Username',font=('Roboto',20))
    label_username.grid(row=1,column=0,pady=(10,0),padx=(50,50),sticky='sw')
    ...
    label_password1.grid(row=3,column=0,pady=(15,0),padx=(50,50),sticky='sw')
    ...
    label_password2.grid(row=6,column=0,pady=(15,0),padx=(50,50),sticky='sw')
    ...
    label_gmail.grid(row=9,column=0,pady=(15,0),padx=(50,50),sticky='sw')
...
# Cust Login/Register Interface value:-
WID = 670
HEI = 580
